...
> **Goal:** Build a production-quality AI system that generates _sendable, brand-accurate marketing emails_ using a structured JSON → renderer architecture. This spec intentionally goes far beyond MVP-level detail to demonstrate systems thinking, robustness, and real-world email constraints.
